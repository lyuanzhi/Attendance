<template>
    <div v-if="!item.hidden && (item.path == '/' || this.$store.state.isFaculty == true)" class="side-menu-item">
        ...
        <el-submenu v-else ref="subMenu" :index="resolvePath(item.path)" popper-append-to-body>
            ...
            <SideMenuItem v-for="child in item.children" :key="child.path" :item="child"
